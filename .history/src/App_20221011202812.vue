    ...
    <a-list bordered :dataSource="list" class="dt_list">
      ...
      <div class="footer" slot="footer">
        ...
        <a-button-group>
          ...
          <a-button :type="viewKey ==='all' ? 'primary':'default' "  @click="changeList('undone')">未完成</a-button>
          <a-button :type="viewKey ==='all' ? 'primary':'default' "  @click="changeList('done')">已完成</a-button>
        </a-button-group>
